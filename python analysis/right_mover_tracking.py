...
# indir = '/storm/topping/cold_pools/runs/lowCAPE/set2'

# indir = '/storm/topping/t1_runs/1500
# indir = '/storm/topping/t1_runs/2500'
# indir = '/storm/topping/t1_runs/3500'

# indir = '/storm/topping/t1_runs/freeslip'
# indir = '/storm/topping/t1_runs/morrison'
# indir = '/storm/topping/t1_runs/sigtor'
# indir = '/storm/topping/t1_runs/ensemble'

# indir = '/storm/topping/strm4_runs/nssl3'
...
for folder in os.listdir(indir):
    ...
    if os.path.isdir(os.path.join(indir, folder)) and folder[:2] in runs:
        ...
        if int(member) != 0:
            sim_dir = f'{indir}/{folder}/{folder[:2]}{member}'
            run = f'{sim_dir}/run/'
        else:
            sim_dir = f'{indir}/{folder}'
            run = f'{sim_dir}/run/'
        ...
        centers_df.to_csv(f'{sim_dir}/rm_tracking.csv')
